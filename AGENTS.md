# AGENTS.md — Unifolio (MF MVP)

Shared, agent-agnostic ground truth: setup, commands, read-order, and non-negotiables.
Read by Claude Code (via `CLAUDE.md`'s pointer) and by Codex natively. If you change
anything here, you change it for every agent working on this repo — don't duplicate
this content elsewhere, point to it instead.
