  ...
  return (
    ...
    >
      ...
      <motion.div variants={staggerItemVariants} className="space-y-3">
        ...
        <button
          type="button"
          className="w-full p-4.5 sm:p-5 rounded-2xl bg-[var(--color-surface)] border border-[var(--color-border)] hover:border-[var(--color-accent)]/50 hover:bg-[color-mix(in_srgb,var(--color-accent)_3%,var(--color-surface))] flex items-center gap-4 text-left transition-all duration-150 cursor-pointer active:scale-[0.99] group shadow-xs select-none"
      ...
      <motion.div variants={staggerItemVariants} className="flex items-center justify-start gap-3 pt-2">
        <button
          type="button"
          onClick={onBack}
