...
export const pieCssVars = {
  ...
  foregroundMuted: "var(--color-text-secondary)",
  label: "var(--color-text-secondary)",
  // Default slice colors from Unifolio chart palette
  slice1: "#22C55E",
  slice2: "#3B82F6",
  slice3: "#8B5CF6",
  slice4: "#F59E0B",
...
export interface PieData {
  ...
  color?: string;
  /** Optional formatted value or current value */
  formattedValue?: string;
  /** Optional fill override for patterns/gradients */
  fill?: string;
}
